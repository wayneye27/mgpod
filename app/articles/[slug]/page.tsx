...
import { getArticle, getFeaturedTools } from "@/lib/content";
    ...
    <main className="mx-auto grid max-w-6xl gap-8 px-5 py-12 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <article className="min-w-0">
        ...
        <div className="prose-content mt-8 rounded-lg border border-line bg-white p-6 shadow-soft">
          ...
          <h2>How to choose</h2>
          <p>
            Start with the task that directly affects revenue: listing clarity, buyer trust, traffic
            quality, or repeat purchase automation. Avoid paying for overlapping tools until one
            workflow is consistently producing sales or measurable time savings.
          </p>
          <ul>
          ...
          <p>
            AI is best used for drafts, variations, and checklists. Final copy should still include
            accurate product details, materials, sizing, shipping notes, and real customer language.
          </p>
          <h3>Are affiliate links included?</h3>
          <p>
            Yes. Some outbound links may be affiliate links. Our recommendations should be checked
            against your own budget, workflow, and current product needs.
          </p>
        </div>
